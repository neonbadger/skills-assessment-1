...
def long_words(word_list):
    ...
    long_words_list = [x for x in word_list if len(x) > 4]
...
def halvesies(number_list):
    ...
    half_list = [x/2.0 for x in number_list]
...
def average(number_list):
    ...
    if len(number_list) != 0:
        mean = sum_numbers(number_list) * 1.0 / len(number_list)
        return mean
    else:
...
def join_strings_with_comma(list_of_words):
    ...
    if len(list_of_words) > 1:
        new_list = [x + ', ' for x in list_of_words[:-1]] 
        new_list.append(list_of_words[-1])
        new_str = join_strings(new_list)
        return new_str
